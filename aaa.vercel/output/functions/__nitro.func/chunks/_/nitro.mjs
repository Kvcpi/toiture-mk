...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "1f5c294d-8bd8-4b63-b9ce-eaa87a9dcb6d",
...
const _lazy_rathxy = () => import('../routes/api/images.mjs');
const _lazy_Qb0Uq5 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/images', handler: _lazy_rathxy, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Qb0Uq5, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Qb0Uq5, lazy: true, middleware: false, method: undefined }
];
...
export { useRuntimeConfig as a, defineRenderHandler as b, createError$1 as c, defineEventHandler as d, getRouteRules as e, getResponseStatusText as f, getQuery as g, getResponseStatus as h, createHooks as i, joinRelativeURL as j, getContext as k, toRouteMatcher as l, createRouter$1 as m, defu as n, hasProtocol as o, parseQuery as p, joinURL as q, isScriptProtocol as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, executeAsync as v, withQuery as w, withTrailingSlash as x, withoutTrailingSlash as y };
